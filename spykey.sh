...
# Coded by @ousemaousema (You don't become a coder by just changing the credits)
# Github: https://github.com/ousemaousema/spykey
...
printf "\n"
printf "      \e[1;92m         Author: @ousemaousema\e[0m\n"
